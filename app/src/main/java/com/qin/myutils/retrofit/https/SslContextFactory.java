package com.qin.myutils.retrofit.https;
...
public class SslContextFactory {
    ...
    public static SSLSocketFactory getSSLSocketFactoryForTwoWay() {
        try {
            InputStream certificate = ContextUtils.getContext().getResources().openRawResource(R.raw.capk);
            ...
            clientKeyStore.load(ContextUtils.getContext().getResources().openRawResource(R.raw.cabks), TRUST_CA_PWD.toCharArray());
