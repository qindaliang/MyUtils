...
public class IntroExampleActivity extends Activity {
    ...
    private final OrderedRealmCollectionChangeListener<RealmResults<Person>> realmChangeListener = (people, changeSet) -> {
        ...
        showStatus("Personer was loaded, or written to. " + insertions + deletions + changes);
    };
    ...
    private void basicCRUD(Realm realm) {
        ...
        realm.executeTransaction(r -> {
            ...
            person.setName("Senior Personer");
            person.setAge(99);
    ...
    private String complexReadWrite(Realm realm) {
        ...
        realm.executeTransaction(r -> {
            ...
            for (int i = 0; i < 10; i++) {
                ...
                person.setName("Personer no. " + i);
                person.setAge(i);
                person.setDog(fido);

                // The field tempReference is annotated with @Ignore.
                // This means setTempReference sets the Personer tempReference
    ...
    private String complexQuery(Realm realm) {
        ...
        // Find all persons where age between 7 and 9 and name begins with "Personer".
        RealmResults<Person> results = realm.where(Person.class)
                .between("age", 7, 9)       // Notice implicit "and" operation
                .beginsWith("name", "Personer").findAll();
