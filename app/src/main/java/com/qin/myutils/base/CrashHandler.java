...
import com.qin.myutils.utils.FileUtils;
import com.qin.myutils.utils.FileUtilss;
import com.qin.myutils.utils.LogUtils;
...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    public void uncaughtException(Thread thread, Throwable ex) {
        if (!handleException(ex) && mDefaultHandler != null) {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    Looper.prepare();
                    ToastUtils.show(ContextUtils.getContext(),"哎呀，程序发生异常啦...");
                    Looper.loop();
                }
            }).start();
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        File file = new File(FileUtilss.createRootPath(mContext) + "/log/" + fileName);
        FileUtilss.createFile(file);
        FileUtilss.writeFile(file.getAbsolutePath(), sb.toString());
