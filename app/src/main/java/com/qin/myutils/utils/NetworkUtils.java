...
public class NetworkUtils {
    ...
    public static int NET_CNNT_BAIDU_OK = 10; // NetworkAvailable
    public static int NET_CNNT_BAIDU_TIMEOUT = 20; // no NetworkAvailable
    public static int NET_NOT_PREPARE = 30; // Net no ready
    public static int NET_ERROR = 40; //net error
