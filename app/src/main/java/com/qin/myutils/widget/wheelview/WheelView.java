...
package com.qin.myutils.widget.wheelview;
...
import com.linfeng.common.widget.wheelview.adapters.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    // Wheel drawables
    private int wheelBackground = 0xffffff;
    private int wheelForeground = 0x000000;
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        paint.setColor(getResources().getColor(0x00000000));
        // 设置线宽
