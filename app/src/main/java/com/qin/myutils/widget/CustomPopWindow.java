package com.qin.myutils.widget;
...
public class CustomPopWindow implements PopupWindow.OnDismissListener {
    ...
    public CustomPopWindow showAsDropDown(View anchor, int xOff, int yOff) {
        if (mPopupWindow != null) {
            ...
            backgroundAlpha(mBackgroundDrakValue);
        }
        return this;
    }
...
//        try {
//            int identifier = mContext.getResources().getIdentifier("statusBarBackground", "id", "android");
//            View view = mWindow.findViewById(identifier);
//            if (view != null && statusDrawable == null) {
//                statusDrawable = view.getBackground();
//            }
//        } catch (Exception e) {
//
//        }
//    }
//
//    private void regainStatusColor() {
//        try {
//            int identifier = mContext.getResources().getIdentifier("statusBarBackground", "id", "android");
//            View view = mWindow.findViewById(identifier);
//            if (view != null && statusDrawable != null) {
//                view.setBackgroundDrawable(statusDrawable);
//            }
//        } catch (Exception e) {
//
//        }
//    }
    ...
    public void setOnClick(int id, View.OnClickListener clickListener) {
        mContentView.findViewById(id).setOnClickListener(clickListener);
    }
